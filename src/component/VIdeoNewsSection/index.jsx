...
import fultab41 from "../../assets/img/post-play.jpg";
import { Link } from "react-router-dom";

const videoPosts = [
  {
    title:
      "Cheers, darling. Virtual cheers. How to throw a virtual cocktail party",
  },
  {
    title:
      "Cheers, darling. Virtual cheers. How to throw a virtual cocktail party",
              ...
              <div className="row">
                <div className="col-lg-8">
                  <div
                    ...
                    style={{
                      background: `url(${fultab41}) center/cover no-repeat`,
                    }}
                  >
