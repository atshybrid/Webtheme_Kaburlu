            ...
            <div className="row">
              <div className="col-12 col-md-10 col-lg-8 m-auto">
                ...
                <p>
                  ...
                  various parts of the state and give them to harder-hit areas.
                  <br />
                  <br />
                ...
                <p>
                  ...
                  parts of the state and give them to harder-hit areas.in New
                  York City, the epicentre of the outbreak in the
                  <br />
                  <br />
                  US, prompted Mr Cuomo to say that he will order the machines
                  be taken from various parts of the state and give them to
                  harder-hit areas.in New York City, the epicentre of the
                  outbreak in
                  <br />
                  <br />
                  the US, prompted Mr Cuomo to say that he will order the
                  machines be taken from various parts of the state and give
                  them to harder-hit areas.in New York City, the epicentre of
                  the outbreak in the US, prompted Mr Cuomo to say that he will
                  order the machines be taken from various parts of the state
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <p>
                      ...
                      aware, and not displaying any symptoms - from unknowingly
...
export default HomeThreeVideoPost2;
