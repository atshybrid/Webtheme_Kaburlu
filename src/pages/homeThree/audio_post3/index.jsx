...
import OurBlogSectionTwo from "../../../component/OurBlogSectionTwo";
import BlogComment from "../../../component/BlogComment";
import { financePosts } from "../../../data/news";

function HomeThreeAudioPost3() {
  return (
    <>
      <MainMenuThree />
          ...
          <div className="row">
            <div className="col-12">
              <div className="bridcrumb">
                <Link to="/">Home</Link> / Archive / post 3
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-md-6 col-lg-8">
              <div className="shadow6">
                ...
                <div className="audio_post">
                  <iframe
                    title="audio"
                    src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/509113785&color=%23ff5500&auto_play=0e&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"
                  />
                </div>
                <div className="padding20 white_bg">
                  <div className="space-20" />
                  <p>
                    ...
                    by 562 to 2,935 - nearly half of all virus-related US deaths
                    recorded yesterday. The White House may advise those in
                    virus hotspots to wear face coverings in public to help stem
                    the spread.\
                    <br />
                    <br />
                    ...
                    country, I just don’t understand why we’re not do ingthat.”
                    <br />
                    <br />
                  ...
                  <p>
                    ...
                    <br />
                    <br />
                    “It’s awfully tough to say, ‘close it down.’ We have to have
                    a little bit of flexibility,” Mr Trump said on Wednesday.
                  </p>
                  <div className="space-40" />
                  ...
                  <p>
                    ...
                    coughing or sneezing, but there is some dispute over how far
                    people should distance themselves from each other, and
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <p>
                        ...
                        <br />
                        On Thursday New York mayor Bill de Blasio urged all New
                        Yorkers to cover their faces when outside
                      </p>
                    </div>
                    <div className="col-md-6">
                  ...
                  <p>
                    ...
                    the virus through the droplets from another person’s sneeze
                    or a cough - and people can be taught how put masks on and
                    take them off correctly, they argue.
                    <br />
                    <br />
                    On Thursday New York mayor Bill de Blasio urged all New
                ...
                <div className="padding20 white_bg">
                  ...
                  <p>
                    ...
                    become something of an icon in South Korea. I just grabbed
                    my wife and said, Look, you speak Korean. You know the
                    president. You know the first lady. You know the ambassador.
                    Let’s talk to them in Korean, and tell them we need their
                    help. Companies in South Korea said would tests.
                  </p>
                  <div className="space-40" />
                </div>
                <div className="audio_post">
                ...
                <div className="padding20 white_bg">
                  ...
                  <p>
                    ...
                    than 1,000 had died in the past 24 hours - the highest daily
                    toll so far in the world.
                    <br />
                    <br />
...
export default HomeThreeAudioPost3;
