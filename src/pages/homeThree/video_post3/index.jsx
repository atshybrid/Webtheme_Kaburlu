            ...
            <div className="col-md-6 col-lg-8">
              <div className="shadow6">
                ...
                <div className="video_img border-radious5">
                  <Link
                    onClick={(e) => openModalVideo(e, "0r6C3z3TEKw")}
                    to="/"
                    className="play_btn"
                  >
                    <img src={single_post1} alt="big1" />
                  </Link>
                  <Link
                    onClick={(e) => openModalVideo(e, "0r6C3z3TEKw")}
                    to="/"
                ...
                <div className="video_img">
                  ...
                  <p className="video_img_text img_desc">
...
export default HomeThreeVideoPost3;
