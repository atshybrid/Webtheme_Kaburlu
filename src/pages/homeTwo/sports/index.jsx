...
import { sports_news } from "../../../data/sports";

function HomeTwoSports() {
  return (
    <>
          ...
          <div className="row">
            <div className="col-md-6 col-lg-8">
              ...
              {sports_news.map((item, i) => (
                <div
                  key={i}
                  className="single_post post_type3 post_type11 post_type21 xs-mb30 mb30"
                >
                  <div className="post_img border-radious7">
                    ...
                    <Link to="/" className="youtube_middle">
